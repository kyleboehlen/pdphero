...
mix.js('resources/js/app.js', 'public/assets/js')
    ...
    .sass('resources/sass/addictions.scss', 'public/assets/css')
    .sass('resources/sass/affirmations.scss', 'public/assets/css')
    .sass('resources/sass/auth.scss', 'public/assets/css')
    .sass('resources/sass/app.scss', 'public/assets/css')
    .sass('resources/sass/bucketlist.scss', 'public/assets/css')
    .sass('resources/sass/feature.scss', 'public/assets/css')
    ...
    .sass('resources/sass/stripe.scss', 'public/assets/css')
