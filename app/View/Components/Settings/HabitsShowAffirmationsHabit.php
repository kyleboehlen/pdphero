...
class HabitsShowAffirmationsHabit extends Component
{
    ...
    {
        $this->settings_id = Setting::HABITS_SHOW_AFFIRMATIONS_HABIT;
    ...
    {
        return view('components.settings.habits-show-affirmations-habit');
    }
}
